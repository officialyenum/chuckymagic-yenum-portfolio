    ...
    var lineDiffPoint = new Chart(lineDiffPointID, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ["#3dcd8b"],
                borderColor: ["#3dcd8b"],
                pointBorderColor: ["transparent","transparent","transparent","transparent","transparent","transparent","transparent"],
                pointBackgroundColor: ["#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b"],
                fill: false,
                borderDash: [5, 5],
                ...
                borderColor: ["#ebebf6"],
                pointBorderColor: ["transparent","transparent","transparent","transparent","transparent","transparent","transparent"],
                pointBackgroundColor: ["#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6"],
                fill: false,
                ...
                borderColor: ["#e75c62"],
                pointBorderColor: ["transparent","transparent","transparent","transparent","transparent","transparent","transparent"],
                pointBackgroundColor: ["#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62"],
                fill: false,
    ...
    var linechartID = document.getElementById("chartjs-basic-line").getContext('2d');
        var lineChart = new Chart(linechartID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["#1ba4fd"],
                    borderColor: ["#1ba4fd"],
                    pointBorderColor: ["#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd"],
                    ...
                    backgroundColor: ["#3dcd8b"],
                    borderColor: ["#3dcd8b"],
                    pointBorderColor: ["#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,
        ...
        var scatterChart = new Chart(scatterChartID, {
            ...
            data: {
                datasets: [{
                    borderColor: ["#1ba4fd"],
                    backgroundColor: ["rgba(27,164,253,0.5)"],
                    pointBorderColor: ["#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd"],
        ...
        var barChart = new Chart(barChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#1ba4fd", "#1ba4fd", "#1ba4fd", "#1ba4fd", "#1ba4fd", "#1ba4fd", "#1ba4fd"],
                        borderColor: ["#1ba4fd", "#1ba4fd", "#1ba4fd", "#1ba4fd", "#1ba4fd", "#1ba4fd", "#1ba4fd"],
                        borderWidth: 1,
                        data: [50, 70, 40, 90, 60, 40, 80, 20]
                    }, {
                        label: 'Series B',
                        backgroundColor: ["#3dcd8b", "#3dcd8b", "#3dcd8b", "#3dcd8b", "#3dcd8b", "#3dcd8b", "#3dcd8b"],
                        borderColor: ["#3dcd8b", "#3dcd8b", "#3dcd8b", "#3dcd8b", "#3dcd8b", "#3dcd8b", "#3dcd8b"],
                        borderWidth: 1,
        ...
        var multiAxisBarChart = new Chart(multiAxisBarChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#1ba4fd","#3dcd8b","#ebebf6","#e75c62","#ffb129","#67d1e1","#181a39"],
                        yAxisID: 'y-axis-1',
            ...
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        ...
                        label: 'Series C',
                        backgroundColor: ["#ebebf6", "#ebebf6", "#ebebf6", "#ebebf6", "#ebebf6", "#ebebf6", "#ebebf6"],
        ...
        var lineBarMixed = new Chart(lineBarMixedID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    type: 'line',
                    label: 'Series C',
                    backgroundColor: ["rgba(235,235,246,0.5)"],
                    borderColor: ["#ebebf6"],
                    pointBorderColor: ["#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6"],
                    pointBorderWidth: 2,
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
        ...
        var datasetArea = new Chart(datasetAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    backgroundColor: ["rgba(184,209,225,0.5)"],
                    borderColor: ["#b8d1e1"],
                    pointBorderColor: ["#b8d1e1","#b8d1e1","#b8d1e1","#b8d1e1","#b8d1e1","#b8d1e1","#b8d1e1","#b8d1e1"],
                    ...
                    backgroundColor: ["rgba(231,92,98,0.5)"],
                    borderColor: ["#e75c62"],  
                    pointBorderColor: ["#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,                      
                    ...
                    backgroundColor: ["rgba(61,205,139,0.5)"],
                    borderColor: ["#3dcd8b"],
                    pointBorderColor: ["#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2, 
                    ...
                    backgroundColor: ["rgba(255,177,41,0.5)"],
                    borderColor: ["#ffb129"],
                    pointBorderColor: ["#ffb129","#ffb129","#ffb129","#ffb129","#ffb129","#ffb129","#ffb129","#ffb129"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2, 
                    ...
                    backgroundColor: ["rgba(27,164,253,0.5)"],
                    borderColor: ["#1ba4fd"],
                    pointBorderColor: ["#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,                                               
                    ...
                    backgroundColor: ["rgba(235,235,246,0.5)"],
                    borderColor: ["#ebebf6"],
                    pointBorderColor: ["#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,
                    ...
                    backgroundColor: ["rgba(24,26,57,0.5)"],
                    borderColor: ["#181a39"],
                    pointBorderColor: ["#181a39","#181a39","#181a39","#181a39","#181a39","#181a39","#181a39","#181a39"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,
                    data: [54, 55, 54, 60, 40, 28, 25, 72],
                    label: 'D7',
        ...
        var stackedArea = new Chart(stackedAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: ["#e75c62"],
                    backgroundColor: ["#e75c62"],
                    pointBorderColor: ["#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,
        ...
        var radarArea = new Chart(radarAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointBackgroundColor: ["#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62","#e75c62"],
                    pointBorderWidth: 1,
                    ...
                    borderColor: ["#ebebf6"],
                    pointBorderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBackgroundColor: ["#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6","#ebebf6"],
                    pointBorderWidth: 1,
                    ...
                    backgroundColor: ["rgba(103,209,225,0.5)"],
                    borderColor: ["#67d1e1"],
                    pointBorderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBackgroundColor: ["#67d1e1","#67d1e1","#67d1e1","#67d1e1","#67d1e1","#67d1e1","#67d1e1","#67d1e1"],
                    pointBorderWidth: 1,
                    data: [36.32, 43.93, 32.54, 33.54, 42.82, 39.34, 35.84, 33.5],
                    label: 'D2',
                    fill: 1
                    ...
                    borderColor: ["#ffb129"],
                    pointBorderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBackgroundColor: ["#ffb129","#ffb129","#ffb129","#ffb129","#ffb129","#ffb129","#ffb129","#ffb129"],
                    pointBorderWidth: 1,
                    ...
                    borderColor: ["#3dcd8b"],
                    pointBorderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBackgroundColor: ["#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b","#3dcd8b"],
                    pointBorderWidth: 1,
                    ...
                    borderColor: ["#1ba4fd"],
                    pointBorderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBackgroundColor: ["#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd","#1ba4fd"],
                    pointBorderWidth: 1,
        ...
        var doughnutChart = new Chart(doughnutChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    backgroundColor: ["#1ba4fd","#3dcd8b","#ebebf6"],
                    label: 'Dataset 1'
                }],
        ...
        var polarAreaChart = new Chart(polarAreaChartID, {
            ...
            data: {
                datasets: [{
                    data: [65,91,56,84,47],
                    borderColor: 'transparent',
                    backgroundColor: ["rgba(231,92,98,0.5)","rgba(27,164,253,0.5)","rgba(61,205,139,0.5)","rgba(255,177,41,0.5)","rgba(235,235,246,0.5)"],
                    label: 'Dataset 1'
                }],
        ...
        var bubbleChart = new Chart(bubbleChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    backgroundColor: ["rgba(27,164,253,0.8)"],
                }]
            },  
            options: {
                aspectRatio: 2,
