...
$(document).ready(function() {
	...
	$('#sparkline-line').sparkline(sparklineLineData, {
        ...
        highlightLineColor: '#ebebf6',
        highlightSpotColor: 'rgba(27,164,253,0.5)'
	});
	/* -- Sparkline - Area Line -- */
    ...
    $('#sparkline-pie').sparkline(sparklinePieData, {
        ...
        width: '150',
        height: '150',
        sliceColors: ['#3dcd8b', '#ebebf6', '#1ba4fd']
    });
	/* -----  Sparkline - Bar  ----- */
    ...
    $("#sparkline-bullet").sparkline(sparklineBulletData, {
	    ...
	    height: '50',
	    targetColor: '#e75c62',
	    performanceColor: '#1ba4fd',
    	rangeColors: ['rgba(27,164,253,0.2)','rgba(27,164,253,0.4)','rgba(27,164,253,0.6)']
	});
    ...
    $("#sparkline-box-plot").sparkline(sparklineBoxPlotData, {
	    ...
	    raw: false,
	    boxLineColor: '#1ba4fd',
	    boxFillColor: 'rgba(27,164,253,0.5)',
	    whiskerColor: '#1ba4fd',
	    outlierLineColor: '#1ba4fd',
	    outlierFillColor: '#ebebf6',
	    medianColor: '#e75c62',
	    targetColor: '#2bcd72'
	});
});